...
public class MainActivityViewModel extends AndroidViewModel {
    ...
    private double dDolares,dEuros;
    ...
    public void cambiarConversion(boolean dolarBoolean, CharSequence razonDeCambio, Editable dolares, Editable euros){
        Double razon = Double.parseDouble(razonDeCambio.toString().substring(0,razonDeCambio.length()-4));
        if (dolares.isEmpty() && euros.isEmpty()){
